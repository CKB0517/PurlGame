...
import tw.edu.ntut.csie.game.PearlPlate.PearlPlate;
import tw.edu.ntut.csie.game.Pointer;
import tw.edu.ntut.csie.game.engine.GameEngine;

public class StateRun extends GameState {
    private PearlPlate _pearlPlate;
...
//        _grab = false;
        ...
        _pearlPlate = new PearlPlate();
        _pearlPlate.initialize();
    }
...
//            _cx += 2;
    ...
    public boolean pointerPressed(List<Pointer> pointers) {
        if (pointers.size() == 1) {
            _pearlPlate.LockGrabbedPearl(pointers.get(0).getX(), pointers.get(0).getY());
        }
...
//        }
    ...
    public boolean pointerMoved(List<Pointer> pointers) {
        _pearlPlate.MovingPearl(pointers.get(0).getX(), pointers.get(0).getY());
...
//            changeState(Game.OVER_STATE);
    ...
    public boolean pointerReleased(List<Pointer> pointers) {
        _pearlPlate.ReleaseGrabbedPearl();
//        _grab = false;
        return false;
    }
